...
export function CategoriesView() {
  ...
  const canEditCategory = can(SystemPermissions.BLOG_CATEGORIES_EDIT);
  const canDeleteCategory = can(SystemPermissions.BLOG_CATEGORIES_DELETE);
      ...
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-2">
            ...
            <PermissionGuard permission={SystemPermissions.BLOG_CATEGORIES_CREATE}>
